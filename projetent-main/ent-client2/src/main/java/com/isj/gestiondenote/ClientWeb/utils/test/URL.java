...
public class URL {
    ...
    public static final String BASE_URL_INT = "http://localhost:9090/api/interventions/";
    ...
    public static final String BASE_URL_BIBLIO = "http://localhost:8081/gestionBiliotheques/v1.O";
}
